...
/***/ function(module, exports, __webpack_require__) {
	...
	var ListContainer = _react2.default.createClass({
		...
		componentDidMount: function componentDidMount() {
			...
			this.firebaseRef = new _firebase2.default('https://sjt-todo.firebaseio.com');
			this.firebaseRef.on('child_added', function (snapshot) {
				_this.setState({
					list: _this.state.list.concat({
						key: snapshot.key(),
						val: snapshot.val()
					})
				});
			...
			this.firebaseRef.on('child_removed', function (snapshot) {
				...
				var newList = _this.state.list.filter(function (item) {
					return item.key !== key;
				});
				_this.setState({
					list: newList
		...
		render: function render() {
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(_List2.default, { items: this.state.list.map(function (item) {
							return item.val;
